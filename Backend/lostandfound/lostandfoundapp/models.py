...
class LostAndFound(models.Model):
    ...
    claimer_name                        = models.CharField(max_length=30, blank=True, null=True)
    claimer_identity_type               = models.CharField(max_length=30, blank=True, null=True, choices = identity_choice_field)
    claimer_identity_number             = models.CharField(max_length=30, blank=True, null=True)
